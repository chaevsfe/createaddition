...
public class ElectricPumpTooltipBehaviour extends KineticTooltipBehaviour<ElectricPumpBlockEntity> {

	public ElectricPumpTooltipBehaviour(ElectricPumpBlockEntity be) {
		super(be);
	}
	...
	public boolean addToGoggleTooltip(List<Component> tooltip, boolean isPlayerSneaking) {
		...
		CALang.builder()
			...
			.forGoggles(tooltip);
		CALang.builder()
			.add(Component.literal(" " + Util.format(blockEntity.getEnergyConsumption()) + "⚡/t ")
