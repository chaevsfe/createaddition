...
import com.zurrtum.create.client.foundation.blockEntity.behaviour.tooltip.MechanicalBearingTooltipBehaviour;
...
public class ServoMotorTooltipBehaviour extends MechanicalBearingTooltipBehaviour {

	public ServoMotorTooltipBehaviour(ServoMotorBlockEntity be) {
		super(be);
	}
