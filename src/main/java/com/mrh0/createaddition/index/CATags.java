...
public class CATags {
    public static class Items {
        ...
        public static TagKey<Item> commonTags(String folder, String name) {
            return TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath("c", String.format("%s/%s", folder, name)));
        }
        ...
        public static TagKey<Item> createAdditionsTags(String folder, String name) {
            return TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(CreateAddition.MODID, String.format("%s/%s", folder, name)));
        }

        public static TagKey<Item> createAdditionsTags(String name) {
            return TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(CreateAddition.MODID, name));
        }

        public static TagKey<Item> modTags(String mod, String name) {
            return TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(mod, name));
        }

        public static TagKey<Item> modTags(String mod, String folder, String name) {
            return TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(mod, String.format("%s/%s", folder, name)));
        }
    }
    ...
    public static class Blocks {
        ...
        public static TagKey<Block> commonTags(String folder, String name) {
            return TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath("c", String.format("%s/%s", folder, name)));
        }
        ...
        public static TagKey<Block> modTags(String mod, String folder, String name) {
            return TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(mod, String.format("%s/%s", folder, name)));
        }
    }
    ...
    public static class Fluids {
        ...
        public static TagKey<Fluid> commonTags(String folder, String name) {
            return TagKey.create(Registries.FLUID, Identifier.fromNamespaceAndPath("c", String.format("%s/%s", folder, name)));
        }
